  ...
  if (!plan) {
    return (
      <div className="flex flex-col gap-3">
        {/* Back button — only shown when editing an existing budget */}
        {isEditing && (
          <button
            type="button"
            onClick={() => { setIsEditing(false); setLoading(true); fetchPlan(); }}
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={() => { setPlan(null); setIsEditing(true); }}
      ...
      {isMobile ? (
        ...
        <div className="flex flex-col gap-3">
          {/* Donut chart + stat chips — always visible */}
          <div
          ...
          >
            {(() => {
              ...
              const segments = categories.map((cat) => ({
                color: cat.color,
                percentage: plan.total_budget > 0 ? cat.allocated / plan.total_budget : 0,
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <svg
                ...
                style={{ transform: showCategories ? "rotate(180deg)" : "rotate(0deg)", transition: "transform 0.2s" }}
              >
            ...
            {showCategories && (
              ...
              >
                <CategoryList categories={categories} totalBudget={plan.total_budget} categoriesOnly />
              </div>
            )}
          </div>

          {/* Transaction log — always visible on mobile */}
          <div
            className="rounded-2xl overflow-hidden"
            style={{ background: "#fff", border: "0.5px solid #ebebeb", minHeight: "400px" }}
          >
            <TransactionLog
